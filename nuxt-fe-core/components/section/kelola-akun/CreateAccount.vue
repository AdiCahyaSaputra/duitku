...
import FormCreate from '@/components/reusable/kelola-akun/form/FormCreate.vue';

const isModalOpen = ref(false);
</script>

<template>
  <ReusableGlobalFormDialog title="Buat Akun"
    ...
    <template #form>
      <FormCreate @create-mutate-executed="() => (isModalOpen = false)" />
    </template>
